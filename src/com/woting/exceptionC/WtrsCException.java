...
public abstract class WtrsCException extends CodeException {
    private static final long serialVersionUID = -6368444046715327382L;
     ...
     * @param bMsg 基础信息
     */
    protected WtrsCException(int c, String bMsg) {
     ...
     * @param message 详细消息
     */
    protected WtrsCException(int c, String bMsg, String message) {
     ...
     */
    protected WtrsCException(int c, String bMsg, Throwable cause) {
     ...
     * @param cause 异常原因，以后通过Throwable.getCause()方法获取它。允许使用null值，指出原因不存在或者是未知的异常
     */
    protected WtrsCException(int c, String bMsg, String message, Throwable cause) {
        super(category, c, bMsg, message, cause);
    }

    protected WtrsCException(int c, String bMsg, String message,Throwable cause, boolean enableSuppression,
