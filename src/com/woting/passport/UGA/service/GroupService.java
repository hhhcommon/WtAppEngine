    ...
    public int updateGroup(GroupPo g) {
        ...
        try {
            ...
            if (sc!=null) {
                ...
                nMsg.setCommand(9);
                Map<String, Object> dataMap1=new HashMap<String, Object>();
                dataMap1.put("GroupInfo", g.toHashMapAsBean());
                MapContent mc1=new MapContent(dataMap1);
                nMsg.setMsgContent(mc1);
                ...
                if (find) oneResult.put("InviteCount", "-1");
                    ...
                    if (igp!=null) {
                        ...
                        if (sc!=null) {
                            ...
                            //发送给beInvitedUserId
//                            nMsg.setToType("("+_beInvitedUserId+"||wt)");
                            Map<String, Object> dataMap=new HashMap<String, Object>();
...
//        }
    ...
    public Map<String, Object> dealInvite(String userId, String inviteUserId, String groupId, boolean isRefuse, String refuseMsg, int type) {
        ...
        if (igl==null||igl.size()==0) {
            ...
            nMsg.setMsgContent(mc);
            //TODO
//            if (type==1) pmm.getSendMemory().addMsg2NotifyQueue(inviteUserId, nMsg);//1邀请,给邀请人发送信息
//            else 
//            if (type==2) pmm.getSendMemory().addMsg2NotifyQueue(userId, nMsg);//2申请,给申请人发送信息
        }
        return m;
    }
    ...
    public Map<String, Object>  dealCheck(String inviteUserId, String beInvitedUserId, String groupId, boolean isRefuse, String refuseMsg) {
        ...
        if (igl==null||igl.size()==0) {
            ...
            if (isRefuse) {
                ...
                nMsg.setMsgContent(mc);
                //TODO
//                pmm.getSendMemory().addMsg2NotifyQueue(inviteUserId, nMsg);
            }
        }
        return m;
    }
...
//                        if (mUdk!=null) {
//                            pmm.getSendMemory().addUniqueMsg2Queue(mUdk, nMsg, new CompareGroupMsg());
//                        }
//                    }
//                }
//                pmm.getSendMemory().addMsg2NotifyQueue(_up.getUserId(), nMsg);//发送通知消息
