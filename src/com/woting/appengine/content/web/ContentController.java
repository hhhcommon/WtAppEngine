...
public class ContentController {
    ...
    public Map<String,Object> getListByCatelog(HttpServletRequest request) {
        ...
        try {
            ...
            if (_temp!=null&&_temp.equals("001")) {
                ...
                bcItem.put("ContentId", "001");
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://alive.rbc.cn/cfm1075");
                ...
                bcItem.put("ContentId", "001");
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://alive.rbc.cn/cfm994");
                ...
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://alive.rbc.cn/cfm1043");
                ...
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://alive.rbc.cn/cfm1051");
                ...
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://alive.rbc.cn/cfm1065");
                ...
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://audio1.hebradio.com/live1");
                ...
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://audio1.hebradio.com/live2");
                ...
                bcItem.put("ContentId", "201");
                bcItem.put("ContentImg", "images/dft_broadcast.png");
                bcItem.put("ContentPlay", "mms://audio1.hebradio.com/live3");
    ...
    private Map<String,Object> getListByZone(HttpServletRequest request) {
        ...
        try {
            ...
            bcItem.put("ContentId", "001");
            bcItem.put("ContentImg", "images/dft_broadcast.png");
            bcItem.put("ContentPlay", "mms://218.61.6.228/xwgb?NSMwIzE=");
            bcItem.put("CurrentContent", "激情岁月");//当前节目
            sl.add(bcItem);
            bcItem=new HashMap<String, Object>();
            bcItem.put("MediaType", "RADIO"); //电台
            ...
            bcItem.put("ContentId", "001");
            bcItem.put("ContentImg", "images/dft_broadcast.png");
            bcItem.put("ContentPlay", "mms://218.61.6.228/tygb?OCMwIzE=");
            ...
            bcItem.put("ContentId", "008");
            bcItem.put("ContentImg", "images/dft_broadcast.png");
            bcItem.put("ContentPlay", "mms://218.61.6.228/jtgb?NiMwIzE=");
            ...
            bcItem.put("ContentId", "101");
            bcItem.put("ContentImg", "images/dft_broadcast.png");
            bcItem.put("ContentPlay", "mms://218.61.6.228/cjgb?MTEjMCMx");
            ...
            bcItem.put("ContentId", "201");
            bcItem.put("ContentImg", "images/dft_broadcast.png");
            bcItem.put("ContentPlay", "mms://218.61.6.228/sqgb?NyMwIzE=");
...
//            bcItem.put("ContentId", "301");
//            bcItem.put("ContentImg", "images/dft_broadcast.png");
//            bcItem.put("ContentPlay", "mms://a.b.c/aaa.mpg");
...
//            sl.add(bcItem);
    ...
    public Map<String,Object> getSeqMaInfo(HttpServletRequest request) {
        ...
        try {
            ...
            Map<String, Object> smInfo=contentService.getSeqMaInfo(contentId, 10, 1);
